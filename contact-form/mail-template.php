...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#8d8e90">
        ...
        . '<img src="' . $site_link . '/contact-form/img/logomail.png" border="0" alt=""/>
                                            </a>
                                        </td>
                                        <td width="393">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td height="30"><img src="' . $site_link . '/contact-form/img/PROMO-GREEN2_01_04.jpg" width="393" height="30" border="0" alt=""/></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td align="center">
                                <img src="' . $site_link . '/contact-form/img/PROMO-GREEN2_02.jpg" alt="" width="598" height="323" border="0"/>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="96%" align="center" style="border-bottom:1px solid #000000" height="50">
                                            <font style="font-family: Verdana, Geneva, sans-serif; color:#1400FF; font-size:18px; " >
                                                   <h4>Contact Message - ' . $comany_name . '</h4>
                                            </font>
                                        </td>
                                        <td width="2%">&nbsp;</td>
                                    </tr>
